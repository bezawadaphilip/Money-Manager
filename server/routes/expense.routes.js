...
router.route('/api/incomes')
  .post(authCtrl.requireSignin, expenseCtrl.cre)

router.route('/api/incomes/yearly')
  .get(authCtrl.requireSignin, expenseCtrl.yearlyIncomes)

  router.route('/api/incomes/current/preview')
  .get(authCtrl.requireSignin, expenseCtrl.currentMonthIncome)

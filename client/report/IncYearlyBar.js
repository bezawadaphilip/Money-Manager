...
import {yearlyIncomes} from './../expense/api-expense.js'
...
export default function Reports() {
    ...
    const handleDateChange = date => {
        setYear(date)
        yearlyIncomes({year: date.getFullYear()},{t: jwt.token}).then((data) => {
          if (data.error) {
            setError(data.error)
          }
            setYearlyExpense(data)
    ...
    return (
      <div>
          <Typography variant="h6" className={classes.title}>Your monthly Income in</Typography>
          ...
          <VictoryChart
                ...
                <VictoryBar
                    ...
                    style={{ data: { fill: "#fa671d", width: 20 }, labels: {fill: "red"} }}
